<template>
   <div>
     <el-button type="primary" @click="changeVal">父组件改变传递给子组件的值</el-button>
   </div>
  <message ref="comp" :title="state.title" @sendMsg="getValue" @getContent="getContent"></message>
  <div>
    <el-button type="primary" @click="handlerClick">按钮触发事件</el-button>
  </div>
  <!-- <div>
